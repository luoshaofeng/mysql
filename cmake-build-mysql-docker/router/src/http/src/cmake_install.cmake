# Install script for directory: /tmp/mysql/router/src/http/src
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xRouterx" OR NOT CMAKE_INSTALL_COMPONENT)
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/mysqlrouter/private/libmysqlrouter_http.so.1" AND
    ...
    file(RPATH_CHECK
         ...
         RPATH "$ORIGIN:$ORIGIN/../lib/mysqlrouter/private:$ORIGIN/../private:$ORIGIN/private")
  endif()
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib/mysqlrouter/private" TYPE SHARED_LIBRARY FILES "/tmp/mysql/cmake-build-mysql-docker/library_output_directory/libmysqlrouter_http.so.1")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/mysqlrouter/private/libmysqlrouter_http.so.1" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/mysqlrouter/private/libmysqlrouter_http.so.1")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/mysqlrouter/private/libmysqlrouter_http.so.1"
         OLD_RPATH "/tmp/mysql/cmake-build-mysql-docker/library_output_directory:::::::::::::::::"
         NEW_RPATH "$ORIGIN:$ORIGIN/../lib/mysqlrouter/private:$ORIGIN/../private:$ORIGIN/private")
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xRouterx" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib/mysqlrouter/private" TYPE SHARED_LIBRARY FILES "/tmp/mysql/cmake-build-mysql-docker/library_output_directory/libmysqlrouter_http_auth_backend.so.1")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/mysqlrouter/private/libmysqlrouter_http_auth_backend.so.1" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/mysqlrouter/private/libmysqlrouter_http_auth_backend.so.1")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/mysqlrouter/private/libmysqlrouter_http_auth_backend.so.1"
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xRouterx" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib/mysqlrouter" TYPE SHARED_LIBRARY FILES "/tmp/mysql/cmake-build-mysql-docker/plugin_output_directory/http_auth_backend.so")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/mysqlrouter/http_auth_backend.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/mysqlrouter/http_auth_backend.so")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/mysqlrouter/http_auth_backend.so"
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xRouterx" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib/mysqlrouter/private" TYPE SHARED_LIBRARY FILES "/tmp/mysql/cmake-build-mysql-docker/library_output_directory/libmysqlrouter_http_auth_realm.so.1")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/mysqlrouter/private/libmysqlrouter_http_auth_realm.so.1" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/mysqlrouter/private/libmysqlrouter_http_auth_realm.so.1")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/mysqlrouter/private/libmysqlrouter_http_auth_realm.so.1"
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xRouterx" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib/mysqlrouter" TYPE SHARED_LIBRARY FILES "/tmp/mysql/cmake-build-mysql-docker/plugin_output_directory/http_auth_realm.so")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/mysqlrouter/http_auth_realm.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/mysqlrouter/http_auth_realm.so")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/mysqlrouter/http_auth_realm.so"
         OLD_RPATH "/tmp/mysql/cmake-build-mysql-docker/library_output_directory:/tmp/mysql/cmake-build-mysql-docker/plugin_output_directory:"
         NEW_RPATH "$ORIGIN:$ORIGIN/../lib/mysqlrouter/private:$ORIGIN/../private:$ORIGIN/private")
    if(CMAKE_INSTALL_DO_STRIP)
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xRouterx" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib/mysqlrouter" TYPE SHARED_LIBRARY FILES "/tmp/mysql/cmake-build-mysql-docker/plugin_output_directory/http_server.so")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/mysqlrouter/http_server.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/mysqlrouter/http_server.so")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/mysqlrouter/http_server.so"
         OLD_RPATH "/tmp/mysql/cmake-build-mysql-docker/plugin_output_directory:/tmp/mysql/cmake-build-mysql-docker/library_output_directory:"
         NEW_RPATH "$ORIGIN:$ORIGIN/../lib/mysqlrouter/private:$ORIGIN/../private:$ORIGIN/private")
    if(CMAKE_INSTALL_DO_STRIP)
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xRouterx" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin" TYPE EXECUTABLE FILES "/tmp/mysql/cmake-build-mysql-docker/runtime_output_directory/mysqlrouter_passwd")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/mysqlrouter_passwd" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/mysqlrouter_passwd")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/mysqlrouter_passwd"
