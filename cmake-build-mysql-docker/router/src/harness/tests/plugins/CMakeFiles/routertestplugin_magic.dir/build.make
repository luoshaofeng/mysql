...
router/src/harness/tests/plugins/CMakeFiles/routertestplugin_magic.dir/magic.cc.o: router/src/harness/tests/plugins/CMakeFiles/routertestplugin_magic.dir/compiler_depend.ts
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/tmp/mysql/cmake-build-mysql-docker/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object router/src/harness/tests/plugins/CMakeFiles/routertestplugin_magic.dir/magic.cc.o"
	cd /tmp/mysql/cmake-build-mysql-docker/router/src/harness/tests/plugins && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -MD -MT router/src/harness/tests/plugins/CMakeFiles/routertestplugin_magic.dir/magic.cc.o -MF CMakeFiles/routertestplugin_magic.dir/magic.cc.o.d -o CMakeFiles/routertestplugin_magic.dir/magic.cc.o -c /tmp/mysql/router/src/harness/tests/plugins/magic.cc
...
router/src/harness/tests/plugins/CMakeFiles/routertestplugin_magic.dir/magic.cc.i: cmake_force
	...
	cd /tmp/mysql/cmake-build-mysql-docker/router/src/harness/tests/plugins && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /tmp/mysql/router/src/harness/tests/plugins/magic.cc > CMakeFiles/routertestplugin_magic.dir/magic.cc.i
...
router/src/harness/tests/plugins/CMakeFiles/routertestplugin_magic.dir/magic.cc.s: cmake_force
	...
	cd /tmp/mysql/cmake-build-mysql-docker/router/src/harness/tests/plugins && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /tmp/mysql/router/src/harness/tests/plugins/magic.cc -o CMakeFiles/routertestplugin_magic.dir/magic.cc.s
...
plugin_output_directory/routertestplugin_magic.so: library_output_directory/libmysqlharness.so.1
...
plugin_output_directory/routertestplugin_magic.so: archive_output_directory/libzlib.a
plugin_output_directory/routertestplugin_magic.so: archive_output_directory/libzstd.a
plugin_output_directory/routertestplugin_magic.so: /usr/lib/aarch64-linux-gnu/libssl.so
plugin_output_directory/routertestplugin_magic.so: /usr/lib/aarch64-linux-gnu/libcrypto.so
plugin_output_directory/routertestplugin_magic.so: archive_output_directory/libbacktrace.a
plugin_output_directory/routertestplugin_magic.so: router/src/harness/tests/plugins/CMakeFiles/routertestplugin_magic.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/tmp/mysql/cmake-build-mysql-docker/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX shared library ../../../../../plugin_output_directory/routertestplugin_magic.so"
	cd /tmp/mysql/cmake-build-mysql-docker/router/src/harness/tests/plugins && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/routertestplugin_magic.dir/link.txt --verbose=$(VERBOSE)
...
router/src/harness/tests/plugins/CMakeFiles/routertestplugin_magic.dir/clean:
	cd /tmp/mysql/cmake-build-mysql-docker/router/src/harness/tests/plugins && $(CMAKE_COMMAND) -P CMakeFiles/routertestplugin_magic.dir/cmake_clean.cmake
...
router/src/harness/tests/plugins/CMakeFiles/routertestplugin_magic.dir/depend:
	cd /tmp/mysql/cmake-build-mysql-docker && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /tmp/mysql /tmp/mysql/router/src/harness/tests/plugins /tmp/mysql/cmake-build-mysql-docker /tmp/mysql/cmake-build-mysql-docker/router/src/harness/tests/plugins /tmp/mysql/cmake-build-mysql-docker/router/src/harness/tests/plugins/CMakeFiles/routertestplugin_magic.dir/DependInfo.cmake --color=$(COLOR)
