...
storage/blackhole/CMakeFiles/blackhole.dir/ha_blackhole.cc.o: storage/blackhole/CMakeFiles/blackhole.dir/compiler_depend.ts
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/tmp/mysql/cmake-build-mysql-docker/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object storage/blackhole/CMakeFiles/blackhole.dir/ha_blackhole.cc.o"
	cd /tmp/mysql/cmake-build-mysql-docker/storage/blackhole && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -MD -MT storage/blackhole/CMakeFiles/blackhole.dir/ha_blackhole.cc.o -MF CMakeFiles/blackhole.dir/ha_blackhole.cc.o.d -o CMakeFiles/blackhole.dir/ha_blackhole.cc.o -c /tmp/mysql/storage/blackhole/ha_blackhole.cc
...
storage/blackhole/CMakeFiles/blackhole.dir/ha_blackhole.cc.i: cmake_force
	...
	cd /tmp/mysql/cmake-build-mysql-docker/storage/blackhole && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /tmp/mysql/storage/blackhole/ha_blackhole.cc > CMakeFiles/blackhole.dir/ha_blackhole.cc.i
...
storage/blackhole/CMakeFiles/blackhole.dir/ha_blackhole.cc.s: cmake_force
	...
	cd /tmp/mysql/cmake-build-mysql-docker/storage/blackhole && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /tmp/mysql/storage/blackhole/ha_blackhole.cc -o CMakeFiles/blackhole.dir/ha_blackhole.cc.s
...
storage/blackhole/libblackhole.a: storage/blackhole/CMakeFiles/blackhole.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/tmp/mysql/cmake-build-mysql-docker/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX static library libblackhole.a"
	cd /tmp/mysql/cmake-build-mysql-docker/storage/blackhole && $(CMAKE_COMMAND) -P CMakeFiles/blackhole.dir/cmake_clean_target.cmake
	cd /tmp/mysql/cmake-build-mysql-docker/storage/blackhole && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/blackhole.dir/link.txt --verbose=$(VERBOSE)
...
storage/blackhole/CMakeFiles/blackhole.dir/clean:
	cd /tmp/mysql/cmake-build-mysql-docker/storage/blackhole && $(CMAKE_COMMAND) -P CMakeFiles/blackhole.dir/cmake_clean.cmake
.PHONY : storage/blackhole/CMakeFiles/blackhole.dir/clean

storage/blackhole/CMakeFiles/blackhole.dir/depend:
	cd /tmp/mysql/cmake-build-mysql-docker && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /tmp/mysql /tmp/mysql/storage/blackhole /tmp/mysql/cmake-build-mysql-docker /tmp/mysql/cmake-build-mysql-docker/storage/blackhole /tmp/mysql/cmake-build-mysql-docker/storage/blackhole/CMakeFiles/blackhole.dir/DependInfo.cmake --color=$(COLOR)
